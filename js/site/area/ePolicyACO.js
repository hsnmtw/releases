...
//var ePolicy = {
    var JS_ePolicyACO_PolicyTemplate =  {
        ...
        "changeSignatoryOrder": function (reorderDelta, callback){
            return JSCommon.changeSignatoryOrder('/ePolicyACO/ApiPolicyTemplate',reorderDelta,callback);
        },
    
        "loadSigners": function () {
            return JSCommon.loadSigners('/ePolicyACO/PolicyTemplate', JS_ePolicyACO_PolicyTemplate.getCurrentId());
        },
        "saveSignatory": function () {
            return JSCommon.saveSignatory('/ePolicyACO/ApiPolicyTemplate');
        },
        "resetSignatoryForm": JSCommon.resetSignatoryForm,
        "editSignatory": function(signatoryId, parentRecordId){
            return JSCommon.editSignatory(signatoryId,parentRecordId,'/ePolicyACO/ApiPolicyTemplate');
        },
        "deleteSignatory": function(callback){
            return JSCommon.deleteSignatory('/ePolicyACO/ApiPolicyTemplate/DeleteSignatory', callback);
        },
        ////// JSCommon //////
    };
    // END [JS_ePolicyACO_PolicyTemplate]
    
    var JS_ePolicyACO_Policy = {

        "addLabel": function(id){
            GET('/ePolicyACO/ApiPolicy/GetAllLabels', function(r){
                ...
                CONFIRM(form,function(model){
                    ...
                    model.PolicyId=id;
                    PUT('/ePolicyACO/ApiPolicy/AddLabel',model,showAlertThenReload);
                },function(){
        ...
        "removeLabel": function(id,label){
            ...
            DELETE('/ePolicyACO/ApiPolicy/RemoveLabel',model,showAlertThenReload);
        },
        
        "addToWorkspace": function(policyIds){
            PUT('/ePolicyACO/ApiPolicy/addToWorkspace',{Policies: policyIds.map(function(x){ return {PolicyId: x}; }) },function(r){
                showAlert(r,function(){
                    CONFIRM('Do you want to open your workspace?',function(){
                        top.location.href='/epolicyaco/policy/workspace';
                    });
                });
            });
        },
        "removeFromWorkspace": function(policyIds){
            DELETE('/ePolicyACO/ApiPolicy/removeFromWorkspace',{Policies: policyIds.map(function(x){ return {PolicyId: x}; }) },showAlertThenReloadAfter2000);
        },
        ...
        "confirmBodyFileUpdate": function(r){
            ...
            show.dialog({message:'Are you sure to update the body file for policy # ' + id + ' ?',size:'mini',onDeny:function(){},onApprove:function(model){
                XHR.POST('/ePolicyACO/PolicyContent/Save',{Id:id,Body:r.Data},showAlert);
            }});
        },
        ...
        "exportToInformationCenter": function(id){
            XHR.POST('/ePolicyACO/ApiPolicy/ExportToInformationCenter/'+id,{Id:id},showAlert);
        },
        ...
        ////// JSCommon //////
        "changeSignatoryOrder": function (reorderDelta, callback){
            return JSCommon.changeSignatoryOrder('/ePolicyACO/ApiPolicy',reorderDelta,callback);
        },
        "loadSigners": function () {
            return JSCommon.loadSigners('/ePolicyACO/Policy', JS_ePolicyACO_Policy.getCurrentId());
        },
        "saveSignatory": function () {
            return JSCommon.saveSignatory('/ePolicyACO/ApiPolicy');
        },
        "resetSignatoryForm": JSCommon.resetSignatoryForm,
        "editSignatory": function(signatoryId, parentRecordId){
            return JSCommon.editSignatory(signatoryId,parentRecordId,'/ePolicyACO/ApiPolicy');
        },
        "deleteSignatory": function(callback){
            return JSCommon.deleteSignatory('/ePolicyACO/ApiPolicy/DeleteSignatory', callback);
        },
        ////// JSCommon //////
        "changeFromEffectiveToApproved": function (id, callback) {
            XHR.PATCH('/ePolicyACO/ApiPolicy/ChangeFromEffectiveToApproved',{"Id":id},function(r){ showAlert(r,callback); });
        },
        ...
        "saveDates" : function (selector) {
            ...
            XHR.PATCH('/ePolicyACO/ApiPolicy/FixDates',model,function (r) {
                showAlert(r, reloadAfter2000, dialogAlert);    
            });
        },
    
        "addNote": function(policyId, comments){
            XHR.PUT('/ePolicyACO/ApiPolicy/AddNote/'+policyId,{"Comment": comments, "PolicyId": policyId}, function(r){ 
                showAlert(r,function(){ 
                    GETHTML('/ePolicyACO/Policy/Notes/'+policyId,'.PolicyNotes'); 
                }); 
            });
        },
        ...
        "sign": function (policyId,status,comments,onSuccess){
            //JSCommon.sign('.approve-reject-form', status, function (smodel) {
                ...
                XHR.PATCH('/ePolicyACO/ApiPolicy/Sign/'+policyId+'/'+status, model, function (r) {
        ...
        "lock": function (policyIds, callback) {
            JS_ePolicyACO_Policy.changeLockStatus(true, policyIds, callback);
        },
    
        "unlock": function (policyIds, callback) {
            JS_ePolicyACO_Policy.changeLockStatus(false, policyIds, callback);
        },
        ...
        "changeLockStatus": function (locked, policyIds, callback) {
            XHR.GET('/ePolicyACO/Policy/All?IsPartial=true&' + policyIds.map(function(id){ return 'Ids=' + id; }).join('&') , function(r){
                ...
                CONFIRM(message,function(model){
                    XHR.PATCH('/ePolicyACO/ApiPolicy/ChangeLockFlag/'+ locked +'/'+ encodeURIComponent(policyIds.join(',')), {}, function(r) {
        ...
        "showPendingChangeRequests": function(id, isManager){
            ...
            if(isManager)
            {
                ...
                DIALOG(null,'/ePolicyACO/Policy/ChangeRequests?isPartial=true&Id='+JS_ePolicyACO_Policy.getCurrentId()+'&Filters='+encodeUrlJSON(filters),'This policy has some pending change request(s):');
        ...
        "updateDates" : function(button, selector, id){
            XHR.POSTFORM(button,selector,'/ePolicyACO/ApiPolicy/UpdatePolicyDates/'+id,closeDialogAfterSave);
        },
        ...
        "embedPDF" : function(id, selector){
            ...
            JS_ePolicyACO_Policy.generateReport(id, function(){
                $('.ui.progress').progress({"percent": 100 });
                //clearInterval(JS_ePolicyACO_Policy.reporthandle);
                setTimeout(function () {
                    PDFObject.embed('/ePolicyACO/Download/Policy/'+id+'?isEmbed=true', selector);
                },1000);
            });
        },
        ...
        "embedPDFAttachments" : function(id, selector){
            PDFObject.embed('/ePolicyACO/Download/PolicyAttachments/'+id+'?isEmbed=true', selector);
        },
        ...
        "previewAttachments": function(id){
            ...
            show.dialog({
                ...
                "onShown": function(){
                    JS_ePolicyACO_Policy.embedPDFAttachments(id, '.policy-attachments-preview');
                }
            });
        },
        ...
        "PREVIEW": function(id) {
            ...
            show.dialog({
                ...
                "onShown": function () {
                    ...
                    XHR.GET('/ePolicyACO/Download/Policy/'+id, function(){
                        PDFObject.embed('/ePolicyACO/Download/Policy/'+id+'?isEmbed=true', '.PreviewTabsContainer .pdf-policy', pdfobjectoptions);
                        PDFObject.embed('/ePolicyACO/Download/PolicyHistory/'+id+'?isEmbed=true', '.PreviewTabsContainer .pdf-history', pdfobjectoptions);
                        PDFObject.embed('/ePolicyACO/Download/PolicyAttachments/'+id+'?isEmbed=true', '.PreviewTabsContainer .pdf-attachments', pdfobjectoptions);
                        PDFObject.embed('/ePolicyACO/Download/PolicyCombined/'+id+'?isEmbed=true', '.PreviewTabsContainer .pdf-combined', pdfobjectoptions);
                    });
                    JS_ePolicyACO_Policy.getReportProgress(id);
        ...
        "openForApproval": function(kind,id){
            var url = '/ePolicyACO/'+kind+'/Open/'+id+'?isPartial=true';
            var header = 'Approval View for '+kind+' # '+id;
            var kindJS = ['Policy','Job Description'].contains(kind) ? 'JS_ePolicyACO_Policy' : 'JS_ePolicyACO_PolicyTermination';
            ...
            return GET(url,function(r){ //POPUP(url,'fullscreen', function(){
                ...
                if(kindJS === 'JS_ePolicyACO_Policy') JS_ePolicyACO_Policy.embedPDFAttachments(id, '.pdfobject.attachments');
            });
        },
        ...
        "openReport" : function (id, index, type){
            ...
            var url   = ['/ePolicyACO/Policy/GetFile/',id,'?fileType=',type].join('');
            PREVIEW(title, url, function(whendone){ JS_ePolicyACO_Policy.generateReport(id, whendone); });
        },
        
        "resetReports" : function(id){
            return XHR.GET('/ePolicyACO/ApiPolicy/ResetReports/'+id,function(r){
                showAlert(r, function () {
                    setTimeout(function () {
                        top.location.reload();
                    }, 2500);
        ...
        "getReportProgress": function (id){
            XHR.GET('/ePolicyACO/Download/GetProgress/'+id, function(percentage){
                var r = (+percentage);
                ...
                if(progress === null || r >= 99) {// || r < 0) {
                    ...
                    return true; //clearInterval(JS_ePolicyACO_Policy.reporthandle);
                }
    
                progress.progress({"percent": r >= 0 ? r : [0,25,50,75][(Math.random()*1000) % 4]});
                    
                if(r >= 0 && r < 100) setTimeout(function () { JS_ePolicyACO_Policy.getReportProgress(id); }, 500);
            });
        },
    
        "generateReport": function (id, whendone){
            $('.ui.progress').progress();
            setTimeout(function () { JS_ePolicyACO_Policy.getReportProgress(id); }, 500);
            return XHR.GET('/ePolicyACO/ApiPolicy/GeneratePDF/'+id, function (r) {
                var progress = $('.ui.progress');
                if(progress !== null) {
                    progress.progress({"percent": 100});
                    //clearInterval(JS_ePolicyACO_PolicyTermination.reporthandle);
                }
        ...
        "archive": function (id) {
            ...
            GETCONFIRM('/ePolicyACO/Policy/ConfirmRevision/'+id,function(model){
                ...
                XHR.PATCH('/ePolicyACO/ApiPolicy/Revision/'+id, model, showAlert);
            });
        },
    
        "reloadForm": function (id) {
            if (isNullOrEmptyOrZero(id)) id = JS_ePolicyACO_Policy.getCurrentId();
            XHR.GET('/ePolicyACO/Policy/Form/' + id + '?isPartial=true&_='+makeid(7), function (r) {
        ...
        "withdraw": function (id) {
            JS_ePolicyACO_Policy.getJustificationForChange("Confirmation to withdraw policy # " + id, function(justification){
                XHR.PATCH('/ePolicyACO/ApiPolicy/Withdraw/'+id, {"PolicyId": id, "Justification": justification}, showAlert);
            });
        },
    
        "cancelChangeRequests": function (listOfPolicyChangeRequests, callback){
            XHR.PATCH('/ePolicyACO/ApiPolicy/CancelChangeRequests',{"Requests": listOfPolicyChangeRequests},function(r){
        ...
        "checkIfDuplicate": function (field,callback){return;
            ...
            var policyId = JS_ePolicyACO_Policy.getCurrentId();
    
            input.classList.remove('duplicate');
            input.setAttribute('data-duplicate',"false");
            hideAlert();
            if(input.value !== '') {
                XHR.POST('/ePolicyACO/ApiPolicy/CheckIfDuplicate/'+policyId,{"Id":policyId,"Title":input.value.trim(),"IndexNumber":input.value.trim(),"Tag":field},function(r){
                    if(typeof r.Status !== 'undefined' && r.Status === 'success'){
                        invoke(callback,r);
                    }else{
                        if(typeof r.Message !== 'undefined' && typeof r.Data !== 'undefined' && typeof r.Data.Id !== 'undefined') 
                            r.Message = ' | <a class="ui link" target="_blank" href="/ePolicyACO/Policy/Form/'+ r.Data.Id +'">'+ r.Data.Id +'</a>'
                        showAlert(r);
        ...
        "getJustificationForChange": function (message, onSuccess){
            ...
            show.confirm({
                ...
                "onApprove": function(model){
                    ...
                    var filters = {"PolicyId":{"Name":'PolicyId',"Where":'IN',"Value":[JS_ePolicyACO_Policy.getCurrentId()]}};
                    GETHTML('/ePolicyACOPolicy/ChangeRequests?isPartial=true&Filters='+encodeUrlJSON(filters),'.pcr0');
        ...
        "delete": function (id) {
            JS_ePolicyACO_Policy.getJustificationForChange("<span class='danger'>Confirmation to delete policy # " + id + "</span>",function(justification){
                XHR.DELETE('/ePolicyACO/ApiPolicy/Delete/'+id, {"Id": id, "Tag": justification}, showAlert);
            });
        },
        ...
        "notifyRequest": function (id, requestType) {
            ...
            XHR.POST('/ePolicyACO/ApiPolicy/NotifyRequest/'+id,{"Id":id, "RequestType": requestType}, function(r){
                showAlert(r, function(){
                    HIDE(tr);
                });
            });
        ...
        "notifySignatory": function (policyId, id) {
            ...
            XHR.POST('/ePolicyACO/ApiPolicy/NotifySignatory/'+policyId+'/' + id, function(r){
        ...
        "notifySignatoryTermination": function (id) {
            ...
            XHR.POST('/ePolicyACO/ApiPolicyTermination/NotifySignatory/' + id, function(r){
        ...
        "autoApprove" : function(id){
            PATCH('/ePolicyACO/ApiPolicy/AutoApprove/'+id,function(r){ showAlert(r, function(){
                JS_ePolicyACO_Policy.reloadForm(id);
            }) });
        },
        ...
        "save": function (newStatus) {
            ...
            if (!JS_ePolicyACO_Policy.validateThisForm()) return dialogAlert({
                Status: 'warning',
            ...
            var onSuccess = function (r) {
                var id = r.Data;
                if(JS_ePolicyACO_Policy.getCurrentId() != id){
                    setTimeout(function () { top.location.href = '/ePolicyACO/Policy/Form/' + id; }, 1500);
                }else{
                    setTimeout(function () { 
                        JS_ePolicyACO_Policy.reloadForm(id);  
                        JS_ePolicyACO_Policy.setSaveButtonsEnabled();
                    }, 2500);
                }
            };
            ...
            if (newStatus === 'Submitted') {
                ...
                show.dialog({
                    "title": 'Confirmation to submit ' + (JS_ePolicyACO_Policy.isJD() ? 'Job Description' : 'Policy') + ' # ' + JS_ePolicyACO_Policy.getCurrentId(),
                    "message": message,
                    "onDeny": function(){
                        //JS_ePolicyACO_Policy.saveForm(newStatus, onSuccess, JS_ePolicyACO_Policy.setSaveButtonsEnabled);
                    },
                    "onApprove": function(model){
        ...
        "saveForm": function (newStatus, onSuccess, onFailure) {
            ...
            JS_ePolicyACO_Policy.setSaveButtonsDisabled();
            ...
            if(model.Status === 'Approved' && !model.IsAutomaticEffectiveOn && !model.IsLocked && !isNullOrEmpty(model.EffectiveOn)){
                ...
                return show.confirm(message,function(response){
                    ...
                    JS_ePolicyACO_Policy.confirmBeforeSave (model, newStatus, function(){ setTimeout(function(){ top.location.reload(); },1500) },onFailure);
                });
            }
            
            JS_ePolicyACO_Policy.confirmBeforeSave (model, newStatus, onSuccess, onFailure);
        },
        ...
        "confirmBeforeSave": function(model, newStatus, onSuccess, onFailure){
            if(['Reopened','Draft'].contains(model.Status))
            {
                ...
                return JS_ePolicyACO_Policy.update(newStatus, model, onSuccess,onFailure);
            } 
            else
            {
                JS_ePolicyACO_Policy.getJustificationForChange("Confirmation to change policy # " + model.Id + " properties",function(justification){
                    model.Tag = justification;
                    JS_ePolicyACO_Policy.update(newStatus, model, onSuccess,onFailure);
                });
            }
        },
    
        "update": function (newStatus, model, onSuccess, onFailure){
            XHR.POST('/ePolicyACO/ApiPolicy/Save/' + model.Id + '/' + newStatus, model, function (r) {
        ...
        "reloadTemplateSignatories": function(){
            ...
            JS_ePolicyACO_Policy.update(model.Status, model, function(r){
                XHR.GET('/ePolicyACO/PolicyTemplate/SignatoriesList/' + templateId, function (r) {
                    ...
                    CONFIRM(message, function(){
                        XHR.PATCH('/ePolicyACO/ApiPolicy/LoadTemplateSignatories/'+JS_ePolicyACO_Policy.getCurrentId(), function (r) {
                            showAlert(r,JS_ePolicyACO_Policy.loadSigners);
                        });
                    });
                });
            }, function(){
        ...
        "previewAudit": function (id) {
            XHR.GET('/ePolicyACO/Policy/History/' + id, function (r) {
        ...
        "setSignatoryDate": function (policyId, id, approveDate) {
            ...
            show.dialog({
				...
				onApprove:function(model){
					...
					XHR.PATCH('/ePolicyACO/ApiPolicy/UpdateSignatoryDate/'+policyId+'/'+id, model, function (r) {
						showAlert(r,function(r){
							if(!JS_ePolicyACO_Policy.isEditable()) return dialogAlert(r);
        ...
        "loadVersions": function (callback) {
            var modelId = JS_ePolicyACO_Policy.getCurrentId();
            XHR.GET('/ePolicyACO/Policy/Versions/' + modelId, function (r) {
        ...
        "loadAttachments": function (callback) {
            var modelId = JS_ePolicyACO_Policy.getCurrentId();
            XHR.GET('/ePolicyACO/Policy/Attachments/' + modelId, function (r) {
        ...
        "changeAttachmentOrder": function (id, delta, callback) {
            XHR.PATCH('/ePolicyACO/ApiPolicy/ChangeAttachmentOrder/'+ JS_ePolicyACO_Policy.getCurrentId() +'/' + id + '/' + delta, function (r) {
                showAlert(r);
                if (typeof r.Status !== 'undefined' && r.Status === 'success') {
                    JS_ePolicyACO_Policy.loadAttachments(callback);
                }
            });
        },
        ...
        "deleteAttachment": function (id) {
            CONFIRM("Are you sure to delete this attachment?", function () {
                ...
                XHR.DELETE('/ePolicyACO/ApiPolicy/DeleteAttachment/'+ JS_ePolicyACO_Policy.getCurrentId() +'/' + id, function (r) {
                    showAlert(r);
                    JS_ePolicyACO_Policy.loadAttachments(function () { });
                    JS_ePolicyACO_Policy.hidePDF();
                });
            });
        },
        ...
        "addAttachment": function (id, filename, filepath) {
            ...
            XHR.PUT('/ePolicyACO/ApiPolicy/AddAttachment/' + id, model, function (r) {
                showAlert(r, function(r){
                    JS_ePolicyACO_Policy.loadAttachments(function () { });
                    JS_ePolicyACO_Policy.hidePDF();
                });
        ...
        "showRequest": function (form, requestId, requestType){
            return show.dialog({
                ...
                "onApprove": function(){
                    ...
                    XHR.PATCH('/ePolicyACO/ApiPolicy/ReviewChangeRequest/'+requestId,model,function(r){
                        showAlert(r, function(){ JS_ePolicyACO_Policy.reloadForm(JS_ePolicyACO_Policy.getCurrentId()); });
                    });
                    return true;
                },
                "onDeny": function(){
                    var model = { "PolicyRequestType": requestType, "RequestId": requestId, "Status": 'Rejected' };
                    XHR.PATCH('/ePolicyACO/ApiPolicy/ReviewChangeRequest/'+requestId, model, showAlert);
                    return true;
                }
        ...
        "setRequestStatus": function (id,status,plolicyRequestType,uniqueRequestId){
            ...
            XHR.PATCH('/ePolicyACO/ApiPolicy/ReviewChangeRequest/'+uniqueRequestId,model, function(r){ 
                JS_ePolicyACO_Policy.hideRequest(plolicyRequestType,r); 
        ...
        "reviewChangeRequest": function(uniqueRequestId,status,callback){
            ...
            XHR.POST('/ePolicyACO/ApiPolicy/ReviewMultipleChangeRequests/'+status+'/'+uniqueRequestId,{"Status":status,"UIDs": [uniqueRequestId]},function(r){
                HIDE(loadingdlg);
                showAlert(r,callback);
            },function () {
                HIDE(loadingdlg);
        ...
        "setSelectedRequestsStatus": function (status){
            ...
            XHR.POST('/ePolicyACO/ApiPolicy/ReviewMultipleChangeRequests/'+status+'/-1,'+urids.join(','),{"Status":status,"UIDs": urids},function(r){
                showAlert(r);
    ...
    // [END] JS_ePolicyACO_Policy

//}


var JS_ePolicyACO_PolicyTermination = {
    
    "getCurrentId": function(){ return getValue('.PolicyTerminationForm #Id[data-parent-id]'); },
    
    ////// JSCommon //////
    "changeSignatoryOrder": function (reorderDelta, callback){
        return JSCommon.changeSignatoryOrder('/ePolicyACO/ApiPolicyTermination',reorderDelta,callback);
    },

    "loadSigners": function () {
        return JSCommon.loadSigners('/ePolicyACO/PolicyTermination', JS_ePolicyACO_PolicyTermination.getCurrentId());
    },
    "saveSignatory": function () {
        return JSCommon.saveSignatory('/ePolicyACO/ApiPolicyTermination');
    },
    "resetSignatoryForm": JSCommon.resetSignatoryForm,
    "editSignatory": function(signatoryId, parentRecordId){
        return JSCommon.editSignatory(signatoryId,parentRecordId,'/ePolicyACO/ApiPolicyTermination');
    },
    "deleteSignatory": function(callback){
        return JSCommon.deleteSignatory('/ePolicyACO/ApiPolicyTermination/DeleteSignatory', callback);
    },
    ////// JSCommon //////
    ...
    "setSignatoryDate": function (policyTerminationId, id, approveDate) {
        ...
        CONFIRM(message,function (formData) {
            ...
            XHR.PATCH('/ePolicyACO/ApiPolicyTermination/UpdateSignatoryDate/'+policyTerminationId+'/'+id, model, function (r) {
                showAlert(r,function(){
    ...
    "previewAudit": function (id) {
        XHR.GET('/ePolicyACO/PolicyTermination/History/' + id, function (r) {
    ...
    "sign": function (id, comments, status, onSuccess) {
        //JSCommon.sign('.approve-reject-form', status, function () {
            ...
            XHR.PATCH('/ePolicyACO/ApiPolicyTermination/Sign/'+id+'/'+status, model, function (r) {
                showAlert(r, onSuccess);
            });
        //});
    },
    ...
    "withdraw": function (formSelector, callback) {
        ...
        CONFIRM('Are you sure to withdraw policy termination form # ' + id + '?', function () {
            XHR.PATCH('/ePolicyACO/ApiPolicyTermination/Withdraw/' + id, function (r) {
                showAlert(r, function(){
                    invoke(callback,r);
    ...
    "embedPDF" : function(id, selector){
        var html = "  <div class='ui progress pink' data-precent='0'>" +
                    ...
                    "  </div>";
        SETHTML(selector, html);
        JS_ePolicyACO_PolicyTermination.generateReport(id, function(){
            $('.ui.progress').progress({"percent": 100 });
            //clearInterval(JS_ePolicyACO_PolicyTermination.reporthandle);
            //
            setTimeout(function () {
                PDFObject.embed('/ePolicyACO/Download/PolicyTermination/'+id+'?isEmbed=true', selector);
            },1000);
        });
    },
    ...
    "openReport" : function (id, index, type){
        ...
        var url   = '/ePolicyACO/PolicyTermination/GeneratePdf/' + id;
        return PREVIEW(title, url, function(whendone){ JS_ePolicyACO_PolicyTermination.generateReport(id, whendone); });
    },
    ...
    "getReportProgress": function (id){
        XHR.GET('/Public/PolicyTerminationReportProgress/'+id,function(percentage){
            ...
            if(progress === null || r >= 99) {// || r < 0) {
                if(r > 0) progress.progress({"percent": 100 });
                return true; //clearInterval(JS_ePolicyACO_PolicyTermination.reporthandle);
            }

            progress.progress({"percent": r });
            if(r >= 0 && r < 100) setTimeout(function () { JS_ePolicyACO_PolicyTermination.getReportProgress(id); }, 500);
        });
    },

    "generateReport": function (id, whendone){
        $('.ui.progress').progress();
        setTimeout(function () { JS_ePolicyACO_PolicyTermination.getReportProgress(id); }, 500);

        return XHR.GET('/ePolicyACO/ApiPolicyTermination/GeneratePDF/'+id, function (r) {
            var progress = $('.ui.progress');
            if(progress !== null) {
                progress.progress({"percent": 100 });
                //clearInterval(JS_ePolicyACO_PolicyTermination.reporthandle);
    ...
    "resetReports" : function(id){
        return XHR.GET('/ePolicyACO/ApiPolicyTermination/ResetReports/'+id, showAlert);
    },
    ...
    "delete": function (formSelector, callback){
        show.dialog({
            ...
            "onApprove": function(){
                ...
                XHR.DELETE('/ePolicyACO/ApiPolicyTermination/Delete/'+model.Id,function(r){
                    showAlert(r, function(){ setTimeout(function(){ 
                        invoke(callback, r);
                        top.location.href='/ePolicyACO/PolicyTermination/Form/0'; }, 1400); 
                    });
                });
            }
        });
    ...
    "reload": function (id) {
        if(!id) return;
        top.location.href = '/ePolicyACO/PolicyTermination/Form/' + id;
    },

    "reloadCommittees": function (id) {
        GETHTML('/ePolicyACO/PolicyTermination/Committees/' + id , '.PolicyTerminationCommittees');
    },

    "reloadReasons": function (id) {
        GETHTML('/ePolicyACO/PolicyTermination/Reasons/' + id, '.PolicyTerminationReasons');
    },

    "saveAndSubmitForApproval": function (formSelector, callback) {
        if(!checkRequiredFields(formSelector)) return;
        var model = SERIALIZE(formSelector);
        XHR.PATCH('/ePolicyACO/ApiPolicyTermination/SaveAndSubmitForApproval/'+model.Id+'/'+model.Status, model, function (r) {
            showAlert(r,function(){
                invoke(callback, r);
                setTimeout(function(){ JS_ePolicyACO_PolicyTermination.reload(r.Data); }, 2500);
            });
        });
    },
    ...
    "save": function (formSelector, callback) {
        if(!checkRequiredFields(formSelector)) return;
        var model = SERIALIZE(formSelector);
        XHR.PATCH('/ePolicyACO/ApiPolicyTermination/Save/'+model.Id+'/'+model.Status, model, function (r) {
            showAlert(r,function(){
                invoke(callback,r);
                setTimeout(function(){ JS_ePolicyACO_PolicyTermination.reload(r.Data); }, 2500);
            });
    ...
    "deleteCommittee": function (committeeId, callback) {
        XHR.DELETE('/ePolicyACO/ApiPolicyTermination/DeleteCommittee/' + committeeId, function (r) {
            showAlert(r, callback);
            JS_ePolicyACO_PolicyTermination.reloadCommittees(JS_ePolicyACO_PolicyTermination.getCurrentId());
        });
    },

    "deleteReason": function (reasonId, callback) {
        XHR.DELETE('/ePolicyACO/ApiPolicyTermination/DeleteReason/' + reasonId, function (r) {
            showAlert(r,callback);
            JS_ePolicyACO_PolicyTermination.reloadReasons(JS_ePolicyACO_PolicyTermination.getCurrentId());
        });
    },
    ...
    "addReason": function (policyTerminationId, successcallback) {
        ...
        CONFIRM(form,function(model){
            ...
            XHR.PUT('/ePolicyACO/ApiPolicyTermination/AddReason/'+policyTerminationId, model, function (r) {
    ...
    "addCommittee": function (terminationModelId, successcallback) {
        ...
        show.dialog({
            ...
            "onShown": function () {
                ...
                XHR.GET('/ePolicyACO/ApiCommittee/All', function (allCommittees) {
                    //allCommittees = r;
            ...
            "onApprove": function(){
                each('.addTerminationCommittee', function (x) {
                    ...
                    XHR.PUT('/ePolicyACO/ApiPolicyTermination/AddCommittee/'+terminationModelId, { "PolicyTerminationId": terminationModelId, "Committee": committee }, function (r) {
                        showAlert(r,successcallback);
                        JS_ePolicyACO_PolicyTermination.reloadCommittees(JS_ePolicyACO_PolicyTermination.getCurrentId());
                    });
                });
...
// [END] JS_ePolicyACO_PolicyTermination



var JS_ePolicyACO_PolicyDashboard = {

    "selectStatus": function (status) {
        XHR.GET('/ePolicyACO/ApiPolicy/GetPoliciesByStatus/' + status, function (r) {
            ...
            for (var i = 0; i < r.Data.length; i++) {
                ...
                a.href = 'javascript:void(JS_ePolicyACO_PolicyDashboard.selectDocument(' + doc.Id + '))';
    ...
    "selectDocument" : function (id) {
        XHR.GET('/ePolicyACO/Policy/Form/' + id + '?isPartial=true&_='+makeid(8), function (r) {
            SETHTML('#dbContent',r);
            var container = document.getElementById('dbDocumentsSelection');
...
// [END] JS_ePolicyACO_PolicyDashboard

var JS_ePolicyACO_Signature = {
    "addSignatureAuthorization": function(){
        XHR.GET('/ePolicyACO/Signature/OnBehalfRequestForm',function(message){
            show.dialog({
                ...
                "onDeny": function(){},
                "onApprove": function(){
                    XHR.PUT('/ePolicyACO/ApiSignature/AddSignatureAuthorization',SERIALIZE('.dlg82736987iy'),function(r){
                        showAlert(r,reloadAfter2000);
                    });
                    return true;
                }
    ...
    "cancelSignatureAuthorizations": function(ids){
        ids.forEach(function(id){
			JS_ePolicyACO_Signature.cancelSignatureAuthorization(id,showAlert);
		});
    },
    "cancelSignatureAuthorization": function(id,callback){
        XHR.PATCH("/ePolicyACO/ApiSignature/CancelSignatureAuthorization",{"Id":id},callback);
    },
    ...
    "reviewSignatureOnBehalfRequest": function(id, status, callback){
        ...
        CONFIRM(message, function (model) {
            XHR.PATCH('/ePolicyACO/ApiSignature/ReviewSignatureAuthorization',model,function(r){
                showAlert(r,callback);
            })
        });
    ...
    "submitChangeRequest": function(username, signature, comments, callback){
        ...
        XHR.POST('/ePolicyACO/ApiSignature/SaveChangeRequest',model,function(r){
    ...
    "reviewRequests" : function(listOfSignatureChangeRequestIds,status,comments,callback){
        ...
        listOfSignatureChangeRequestIds.forEach(function (id) {
            ...
            DISABLE('[data-approve-reject-button]');
            XHR.PATCH('/ePolicyACO/ApiSignature/ReviewChangeRequest',{"ChangeRequestId":id, "Status":status, "ReviewComments": comments},function (result) {
...
// [END] JS_ePolicyACO_Signature


var JS_ePolicyACO_PolicySignatory = {
...
// [END] JS_ePolicyACO_PolicySignatory